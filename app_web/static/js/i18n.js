...
(function() {
  ...
  const translations = {
    zh: {
      ...
      'fit.eyebrow': '自动模型选择 / 拟合',
      'fit.title': '用现有高精度拟合核心在浏览器里选模型、输出参数和残差图。',
      'fit.subtitle': '粘贴 x,y,(σ) 数据即可运行自动模型库（多项式/指数/对数/序列加速等），展示最优模型参数、AIC/BIC/R²、残差与拟合曲线。',
      'fit.chip1': 'AUTO_MODELS',
      ...
      'fit.modeLabel': '拟合模式',
      'fit.modeAuto': '自动模型选择',
      'fit.modePreset': '预设模型 (Preset)',
      'fit.modeCustom': '自定义模型表达式',
      'fit.modePoly': '多项式拟合',
      'fit.modeInverse': '1/x^p 展开',
      'fit.modePade': 'Padé 拟合',
      'fit.modePowerLimit': '幂律极限拟合',
      'fit.modeLogPoly': '对数多项式',
      'fit.modeExpCombo': '通用指数基',
      'fit.presetModelLabel': '选择预设模型',
      'fit.presetModelHint': '预设模型库包含线性、多项式、对数、指数、1/x系列等常用模型。',
      ...
      'fit.submitHint': '支持自动模型选择、指定内置模型或自定义表达式。',
      ...
      'fit.summaryLabel': '模型尝试摘要',
      'fit.summaryHint': '包含失败/成功模型与 AIC/χ²。',
      ...
      'fit.logPolyHint': '对数多项式模型（要求 x>0），结构与自动模型库保持一致。',
      'fit.expComboHint': '通用指数基模型，沿用内置参数基础。',
    ...
    en: {
      ...
      // Fitting page
      'fit.eyebrow': 'Auto Model Selection / Fitting',
      'fit.title': 'Use high-precision fitting core in browser to select models, output parameters and residual plots.',
      'fit.subtitle': 'Paste x,y,(σ) data to run auto model library (polynomial/exponential/logarithmic/sequence acceleration), show optimal model parameters, AIC/BIC/R², residuals and fitted curves.',
      'fit.chip1': 'AUTO_MODELS',
      ...
      'fit.modeAuto': 'Auto model selection',
      'fit.modePreset': 'Preset model',
      ...
      'fit.modeLogPoly': 'Log polynomial',
      'fit.modeExpCombo': 'General exponential basis',
      'fit.presetModelLabel': 'Select preset model',
      'fit.presetModelHint': 'Preset library includes linear, polynomial, logarithmic, exponential, 1/x series and other common models.',
      ...
      'fit.submitHint': 'Supports auto model selection, preset models or custom expressions.',
      ...
      'fit.metricsHint': 'AIC priority for model selection.',
      'fit.plotLabel': 'Fitting & Residual Plots',
      'fit.plotHint': 'Rendered with Matplotlib showing fitted and residual curves.',
      'fit.summaryLabel': 'Model Attempt Summary',
      'fit.summaryHint': 'Includes failed/successful models with AIC/χ².',
      ...
      'fit.logPolyHint': 'Log-polynomial model (requires x>0), consistent with the auto model library.',
      'fit.expComboHint': 'General exponential basis model using built-in parameter defaults.',
