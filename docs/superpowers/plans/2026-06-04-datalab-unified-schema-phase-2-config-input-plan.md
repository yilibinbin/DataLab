...
- [x] **Step 1: Add error/constants schema tests**
...
- [x] **Step 1: Add schema-binding tests for extrapolation/statistics**
...
- [x] **Step 1: Add global option binding tests**
...
- [x] **Step 3: Bind global options**

Keep existing parallel behavior; only migrate metadata.

- [x] **Step 4: Run Batch D tests**
