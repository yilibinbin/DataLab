...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[
    ...
    \node[block, below=of parse] (engine) {\textbf{Core engines}\\
      ...
      Fitting: \texttt{fitting/} (polynomial, inverse-power, Padé, power-limit, custom, and self-consistent models; parameter management; fit metrics)\\
...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[
    ...
    child { node[box]{Input}
        ...
        child { node[box]{Fit mode\\Polynomial / inverse / Padé\\power-limit / custom / implicit} }
...
\begin{itemize}
  ...
  \item fitting: explicit polynomial, inverse-power, Padé, power-limit, custom, and self-consistent models, producing parameter estimates, fitted curves, and metrics (e.g., covariance matrices and parameter uncertainties);
